...
const programmeSlides: Slide[] = [
  ...
  },
  {
    ...
    day: 1,
    stage: 'Creator Stage',
    // Replaced single-speaker session with a real 3-person session
    time: '13:00 - 13:30',
    topic: 'Beyond Salary: Building Passive Income in 2026',
    type: 'talk',
    speakers: [
      {
        name: 'Gin Chong',
  ...
  },
  {
    ...
    day: 1,
    stage: 'Monie Stage',
    // Replaced with real session that has 2 speakers + moderator
    time: '18:15 - 19:00',
    topic: "When Passion Meets Planning: How to Turn Dreams into Reality",
    type: 'talk',
    speakers: [
      {
        name: 'Christy Ng',
  ...
  },
  {
    ...
    day: 2,
    stage: 'Monie Stage',
    // Replaced with a real engagement panel (3-person including moderator)
    time: '13:45 - 14:30',
    topic: 'Gaji Naik, Kenapa Duit Tetap Tak Cukup?',
    type: 'panel',
    speakers: [
      {
        name: 'Faiz Azmi',
  ...
  },
  {
    ...
    day: 1,
    stage: 'Creator Stage',
    // Replaced with a real panel that has 2 speakers + moderator
    time: '15:30 - 16:00',
    topic: 'From Audience to Empire: How Brands and Startups Scale Across Southeast Asia',
    type: 'panel',
    speakers: [
      {
        name: 'Gareth Tan',
