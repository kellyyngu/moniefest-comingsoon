...
const foodieLogo = `${import.meta.env.BASE_URL}optimized/Foodie-Red.webp`;
const spireLogo = `${import.meta.env.BASE_URL}optimized/Spire-Black.webp`;
const benchxcapitalLogo = `${import.meta.env.BASE_URL}optimized/benchxcapital.webp`;
const gambitTrusteesLogo = `${import.meta.env.BASE_URL}optimized/gambitTrustees.webp`;
const gambitCustodyLogo = `${import.meta.env.BASE_URL}optimized/gambitCustody.webp`;
const lunoLogo = `${import.meta.env.BASE_URL}optimized/luno.webp`;
const moomooLogo = `${import.meta.env.BASE_URL}optimized/moomoo.webp`;
const microleapLogo = `${import.meta.env.BASE_URL}optimized/microleap.webp`;
...
const capbayLogo = `${import.meta.env.BASE_URL}optimized/capbay.png`;
const ncspaceLogo = `${import.meta.env.BASE_URL}optimized/NCSPACE.svg`;
const wealthFortLogo = `${import.meta.env.BASE_URL}optimized/WealthFort.svg`;
const cgsiLogo = `${import.meta.env.BASE_URL}optimized/CGSI.svg`;
const ctosLogo = `${import.meta.env.BASE_URL}optimized/CTOS.svg`;
const publicMutualLogo = `${import.meta.env.BASE_URL}optimized/publicMutual.png`;
const cboeLogo = `${import.meta.env.BASE_URL}optimized/CBOE.svg`;
const stayWokePropertyLogo = `${import.meta.env.BASE_URL}optimized/stayWokeProperty.svg`;
const zietLogo = `${import.meta.env.BASE_URL}optimized/ziet.svg`;
const noMoneyLahLogo = `${import.meta.env.BASE_URL}optimized/NoMoneyLah.svg`;
const bbkNetworkLogo = `${import.meta.env.BASE_URL}optimized/BBKNetwork.svg`;
const iherngLogo = `${import.meta.env.BASE_URL}optimized/iherng.png`;
const insightInvestsLogo = `${import.meta.env.BASE_URL}optimized/insightInvests.svg`;
const financeLangLogo = `${import.meta.env.BASE_URL}optimized/financeLang.PNG`;
const insightsAnalyticsBerhadLogo = `${import.meta.env.BASE_URL}optimized/insightsAnalyticsBerhad.svg`;
const traddictivLogo = `${import.meta.env.BASE_URL}optimized/traddictiv.svg`;
const tealiveLogo = `${import.meta.env.BASE_URL}optimized/tealive.svg`;
const kenangaLogo = `${import.meta.env.BASE_URL}optimized/kenanga.png`;
const mrmoneyLogo = `${import.meta.env.BASE_URL}optimized/MrMoney.avif`;
const wabikongLogo = `${import.meta.env.BASE_URL}optimized/wabikong.svg`;
const taylorsUniversityLogo = `${import.meta.env.BASE_URL}optimized/taylorsUniversitylogo.jpg`;
const tianGeLogo = `${import.meta.env.BASE_URL}optimized/tianGe.svg`;
const gyakuCapitalLogo = `${import.meta.env.BASE_URL}optimized/gyakuCapital.svg`;
const printciousLogo = `${import.meta.env.BASE_URL}optimized/printcious.svg`;
const saturnaLogo = `${import.meta.env.BASE_URL}optimized/saturna.svg`;
const ecoAsiaCapitalLogo = `${import.meta.env.BASE_URL}optimized/ecoAsiaCapital.svg`;
const grandpineCapitalLogo = `${import.meta.env.BASE_URL}optimized/grandpineCapital.svg`;
const mpgLogo = `${import.meta.env.BASE_URL}optimized/MPG.svg`;
const endeavorLogo = `${import.meta.env.BASE_URL}optimized/endeavor.svg`;
const asriAhmadAcademyLogo = `${import.meta.env.BASE_URL}optimized/asriAhmadAcademy.svg`;
const uhnwLogo = `${import.meta.env.BASE_URL}optimized/UHNW.jpeg`;
const skyworldLogo = `${import.meta.env.BASE_URL}optimized/skyworld.png`;
const sinegyLogo = `${import.meta.env.BASE_URL}optimized/sinegy.svg`;
const zusLogo = `${import.meta.env.BASE_URL}optimized/zus.svg`;
const bbbWealthLogo = `${import.meta.env.BASE_URL}optimized/BBBwealth.svg`;
const colonyLogo = `${import.meta.env.BASE_URL}optimized/colony.svg`;
const pmbLogo = `${import.meta.env.BASE_URL}optimized/PMB.svg`;
const asnbLogo = `${import.meta.env.BASE_URL}optimized/ASNBlogo.jpg`;
const rytBankLogo = `${import.meta.env.BASE_URL}optimized/rytBank.svg`;
const hlbLogo = `${import.meta.env.BASE_URL}optimized/HLB.svg`;
const activ8Logo = `${import.meta.env.BASE_URL}optimized/ACTIV8.svg`;
const financialFaizLogo = `${import.meta.env.BASE_URL}optimized/financialFaiz.svg`;
const fnbTalkLogo = `${import.meta.env.BASE_URL}optimized/F&B.svg`;
const jaLogo = `${import.meta.env.BASE_URL}optimized/JA.svg`;
const moneyBraderLogo = `${import.meta.env.BASE_URL}optimized/moneyBrader.svg`;
const dasherLogo = `${import.meta.env.BASE_URL}optimized/dasher.png`;
const paramountPropertyLogo = `${import.meta.env.BASE_URL}optimized/paramountProperty.png`;
const chuckLogo = `${import.meta.env.BASE_URL}optimized/chuckLogo.PNG`;
const talentCorpLogo = `${import.meta.env.BASE_URL}optimized/talentCorp.png`;
const ekonomiRakyatLogo = `${import.meta.env.BASE_URL}optimized/ekonomiRakyat.svg`;
const beyondInsightsLogo = `${import.meta.env.BASE_URL}optimized/beyondInsights.svg`;
const fpamLogo = `${import.meta.env.BASE_URL}optimized/FPAM.png`;
const maybankLogo = `${import.meta.env.BASE_URL}optimized/maybank.png`;
const mybwLogo = `${import.meta.env.BASE_URL}optimized/MYBW.svg`;
const ijmRimbayuLogo = `${import.meta.env.BASE_URL}optimized/RimbayuLogo.svg`;
const rianaDutamasLogo = `${import.meta.env.BASE_URL}optimized/rianaDutamas.svg`;
const ijmRimbayuBanner = `${import.meta.env.BASE_URL}optimized/IJMRimbayuBanner.jpg`;
const rianaDutamasBanner = `${import.meta.env.BASE_URL}optimized/RianaDutamasBanner.jpg`;
const joeyYapGroupLogo = `${import.meta.env.BASE_URL}optimized/joeyYapGroup.jpeg`;
const niagaSahamLogo = `${import.meta.env.BASE_URL}optimized/niagaSaham.png`;
const epfLogo = `${import.meta.env.BASE_URL}optimized/EPF.svg`;
const greatEasternLogo = `${import.meta.env.BASE_URL}optimized/greatEastern.jpeg`;
const sbsLogo = `${import.meta.env.BASE_URL}optimized/SBS.png`;
const shanghaiLogo = `${import.meta.env.BASE_URL}optimized/shanghaiLogo.svg`;
const tradeViewCapitalLogo = `${import.meta.env.BASE_URL}optimized/TradeViewCapital.svg`;
const oppoLogo = `${import.meta.env.BASE_URL}optimized/oppo.png`;
const grabLogo = `${import.meta.env.BASE_URL}optimized/grab.svg`;
const uncleJeffLogo = `${import.meta.env.BASE_URL}optimized/uncleJeff.svg`;
const vanzoLogo = `${import.meta.env.BASE_URL}optimized/vanzo.jpeg`;
const ticketmelonLogo = `${import.meta.env.BASE_URL}optimized/ticketmelon.svg`;
const nineSharesLogo = `${import.meta.env.BASE_URL}optimized/9shares.jpeg`;
const pYTCHLogo = `${import.meta.env.BASE_URL}optimized/PYTCH.png`;
const theFinancialTodayLogo = `${import.meta.env.BASE_URL}optimized/theFinancialToday.jpg`;
const ddnkLogo = `${import.meta.env.BASE_URL}optimized/DDNK.png`;
const bondsupermartLogo = `${import.meta.env.BASE_URL}optimized/bondsupermart.png`;
const LFFGroupLogo = `${import.meta.env.BASE_URL}optimized/LFFGroup.png`;
const saatDimensiLogo = `${import.meta.env.BASE_URL}optimized/saatDimensi.jpeg`;
const troopersLogo = `${import.meta.env.BASE_URL}optimized/troopers.png`;
const kleverstockLogo = `${import.meta.env.BASE_URL}optimized/kleverstock.png`;
const JYYGroupLogo = `${import.meta.env.BASE_URL}optimized/JYYGroup.png`;
const faAdvisoryLogo = `${import.meta.env.BASE_URL}optimized/FAAdvisory.webp`;
const mascoLogo = `${import.meta.env.BASE_URL}optimized/masco.png`;
const sumaCollegeLogo = `${import.meta.env.BASE_URL}optimized/SUMACollege.png`;
const picoLogo = `${import.meta.env.BASE_URL}optimized/pico.png`;
const upboundLogo = `${import.meta.env.BASE_URL}optimized/upboundLogo.png`;
const sultLogo = `${import.meta.env.BASE_URL}optimized/sult.png`;
const kellyLogo = `${import.meta.env.BASE_URL}optimized/kelly.png`;
const kellyLogo2 = `${import.meta.env.BASE_URL}optimized/kellyLogo2.png`;
